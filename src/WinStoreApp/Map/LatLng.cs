...
namespace WinStoreApp.Map
{
    ...
    public class LatLng : Location, IEquatable<LatLng>
    {
        ...
        {
            StringBuilder sb = new StringBuilder(50); //default to 50 in the internal array.
            sb.Append(this.Latitude.ToString(format, CultureInfo.InvariantCulture));
            sb.Append(",");
            sb.Append(this.Longitude.ToString(format, CultureInfo.InvariantCulture));
